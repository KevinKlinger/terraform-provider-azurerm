...
func TestSmartDetectionRuleV0ToV1(t *testing.T) {
	testData := []struct {
	...
	}{
		{
			...
			expected: utils.String("/subscriptions/12345678-1234-5678-1234-123456789012/resourceGroups/group1/providers/Microsoft.Insights/components/component1/smartDetectionRule/rule1"),
		},
		{
