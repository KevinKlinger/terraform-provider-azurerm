...
var _ resourceid.Formatter = VaultId{}

func TestVaultIDFormatter(t *testing.T) {
	actual := NewVaultID("12345678-1234-9876-4563-123456789012", "group1", "vault1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.RecoveryServices/vaults/vault1"
	if actual != expected {
