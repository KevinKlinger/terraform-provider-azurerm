...
var _ resourceid.Formatter = IotHubDpsId{}

func TestIotHubDpsIDFormatter(t *testing.T) {
	actual := NewIotHubDpsID("12345678-1234-9876-4563-123456789012", "resGroup1", "provisioningService1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Devices/provisioningServices/provisioningService1"
	if actual != expected {
...
func TestIotHubDpsID(t *testing.T) {
	...
	for _, v := range testData {
		...
		actual, err := IotHubDpsID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
