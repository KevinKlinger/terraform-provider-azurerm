...
var _ resourceid.Formatter = IntegrationAccountAssemblyId{}

func TestIntegrationAccountAssemblyIDFormatter(t *testing.T) {
	actual := NewIntegrationAccountAssemblyID("12345678-1234-9876-4563-123456789012", "group1", "account1", "assembly1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Logic/integrationAccounts/account1/assemblies/assembly1"
	if actual != expected {
...
func TestIntegrationAccountAssemblyID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *IntegrationAccountAssemblyId
	}{
	...
	for _, v := range testData {
		...
		actual, err := IntegrationAccountAssemblyID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
