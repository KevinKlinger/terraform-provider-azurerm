...
We intend to support the `timeouts` block in version 2.0 of the Azure Provider - which will allow timeouts to be specified on resources (as shown above). [This feature request is being tracked here](https://github.com/kevinklinger/terraform-provider-azurerm/v2/issues/171) and will form part of the 2.0 release of the AzureRM Provider.
...
You can follow along with the work in the 2.0 release [in this GitHub Milestone](https://github.com/kevinklinger/terraform-provider-azurerm/v2/milestone/31) - and [in this GitHub Issue](https://github.com/kevinklinger/terraform-provider-azurerm/v2/issues/2807).
